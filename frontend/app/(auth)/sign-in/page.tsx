      ...
      {!showEmailForm ? (
        <>
          ...
          <div className="flex justify-center gap-3">
            ...
            <motion.button
              {...tapScale}
              className="wireframe-card flex flex-col items-center justify-center w-[88px] h-[88px] hover-glow-border"
            >
        ...
        <div className="space-y-5">
          ...
          <motion.button
            {...tapScale}
            className="w-full py-3 rounded-lg bg-gold/10 border border-gold/20 text-gold font-medium text-sm uppercase tracking-wider hover:bg-gold/20 transition-all flex items-center justify-center gap-2"
          >
            Sign In
