...
export function OnboardingGateBanner() {
  ...
  return (
    <div className="mb-6 mx-6 md:mx-8 animate-in slide-in-from-top-4 duration-700">
      <div className="relative overflow-hidden rounded-[24px] border border-amber-300/30 bg-gradient-to-r from-amber-400/20 to-black p-0.5 shadow-lg">
        <div className="flex flex-col md:flex-row items-center justify-between rounded-[23px] bg-black/80 px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div className="text-center md:text-left">
              <h3 className="text-sm font-semibold text-amber-50">Strategic Onboarding Required</h3>
              <p className="text-[11px] text-amber-100/60 leading-tight">
          ...
          <Link 
            ...
            className="mt-3 md:mt-0 flex items-center gap-2 rounded-full bg-amber-400 px-5 py-2 text-[11px] font-bold text-black uppercase tracking-widest transition-all hover:scale-105 active:scale-95 shadow-[0_0_15px_rgba(251,191,36,0.3)]"
          >
